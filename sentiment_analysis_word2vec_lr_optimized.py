...
def review_to_wordlist(review, remove_stopwords=True):
    ...
    # 4. Remove non-letters and numbers
...
def main():
    ...
    print("\n调优逻辑回归...")
    param_grid = {
        'C': [0.1, 0.5, 1.0, 1.5, 2.0, 2.5, 3.0, 4.0, 5.0],
        'solver': ['liblinear'],
        'penalty': ['l1', 'l2']
    }
    ...
    output.to_csv("Word2Vec_Average_LR_Optimized.csv", index=False, quoting=3)
    
    print("\n任务完成！")
    print(f"提交文件已生成: Word2Vec_Average_LR_Optimized.csv")
