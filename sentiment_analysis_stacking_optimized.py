...
def main():
    ...
    base_models = [
        ...
        ('lgbm', LGBMClassifier(n_estimators=300, learning_rate=0.1, max_depth=5, random_state=42)),
    ...
    output.to_csv("Stacking_Ensemble_Optimized.csv", index=False, quoting=3)
    print("优化的Stacking集成学习提交文件已生成: Stacking_Ensemble_Optimized.csv")
    print("任务完成！")
